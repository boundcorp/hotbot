...
class ContentTags(TextChoices):
    AUTOMATED = 'automated', 'Automated, a message that is clearly automated, such as a bot or AI'
    ...
    SPAM = 'spam', 'Spam, garbage, not a real message'
    PROMOTIONAL = 'promotional', 'Promotional, a message that is clearly a promotion for a product or service'
