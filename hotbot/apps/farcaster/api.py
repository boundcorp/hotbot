...
class NeynarClient:
    def __init__(self):
        ...
        self.base_headers = {"accept": "application/json", "api_key": self.api_key}
    ...
    def _get_paginated_all_results(
        self, url, headers, limit=100, cursor=None, result_key="results"
    ):
        results = []
        cursor = None
        while True:
    ...
    def find_channels(self, channel_name_or_id):
        ...
        return self._get_paginated_all_results(
            url, self.base_headers, result_key="channels"
        )
    ...
    def post_cast(
        self, text, parent_hash=None, parent_url=None, mentions=None, embeds=None
    ):
