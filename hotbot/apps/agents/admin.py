...
class MessageAdmin(admin.ModelAdmin):
    list_display = ['openai_id', 'success', 'workflow', 'model', 'duration', 'completion_tokens', 'prompt_tokens']
    search_fields = ['openai_id', 'model']
    list_filter = ['success', 'model']
    readonly_fields = [field.name for field in Message._meta.fields] + ['formatted_content']
