...
if "TEST_USE_ENV" not in os.environ:
    ...
    del sys.modules["hotbot.settings"]
    del sys.modules["hotbot.settings.project"]

from hotbot.settings import *
...
EMAIL_BACKEND = "hotbot.conf.test_settings.MockEmailBackend"
