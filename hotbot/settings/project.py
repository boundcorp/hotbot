...
DATABASE_PASSWORD = os.environ.get("DATABASE_PASSWORD", "hotbot")
DATABASES = {
...
APP_HOSTNAME = os.environ.get("APP_HOSTNAME", "hotbot.boundcorp.net")
